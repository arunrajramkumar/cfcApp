...
<div class="span7">
    ...
    <form:form commandName="CFCUser" method="post" action="signup" id="signupForm" autocomplete="off"
               cssClass="well form-horizontal" onsubmit="return validateUser(this)">
        <spring:bind path="CFCUser.username">
        ...
        <spring:bind path="CFCUser.password">
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
        </spring:bind>
        ...
        <spring:bind path="CFCUser.passwordHint">
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
        </spring:bind>
        ...
        <spring:bind path="CFCUser.firstName">
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
        </spring:bind>
        ...
        <spring:bind path="CFCUser.lastName">
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
        </spring:bind>
        ...
        <spring:bind path="CFCUser.email">
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
        </spring:bind>
